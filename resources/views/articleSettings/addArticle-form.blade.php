                ...
                <form method="post" action="{{ route('addArticle') }}" id="addArticleForm" enctype="multipart/form-data"
                    ...
                    <div class="grid gap-2 mb-6">
                        ...
                        <div class="grid grid-cols-4 gap-2">
                            ...
                            <!-- Prix Article -->
                            <x-text-input id="prixArticle" class="col-span-1" type="number" name="prixArticle" required
                                step="0.01" min="0" placeholder="Prix ($)" value="{{ old('prixArticle') }}" />

                            <x-text-input id="quantiteArticle" class="col-span-1" type="number" name="quantiteArticle"
                        ...
                        <div class="grid grid-cols-4 gap-2">
                            ...
                            <textarea id="descriptionArticle" name="descriptionArticle"
                                ...
                                placeholder="Description" required value="{{ old('descriptionArticle') }}"></textarea>

                            <!-- Mots-clés -->
                            <textarea id="motClesArticle" name="motClesArticle" rows="2"
                                class="col-span-2 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                placeholder="#Funky#MeilleurArticleEver#Automne#Aussiété" value="{{ old('motClesArticle') }}"></textarea>
                        </div>
                    </div>
