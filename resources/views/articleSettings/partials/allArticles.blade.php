 ...
 <div class="rounded-[12px] m-sectionY flex flex-wrap justify-start gap-input overflow-auto relative" id="articlesContainer"
                     ...
                     <div class="w-full h-[50%] flex items-center justify-center" x-data="{ openDeleteArticle: false }">
                         <button
                          ...
                          $dispatch('set-id', {{ $article->id_article }});">
                             <svg class="w-full h-full text-blue-900 hover:text-red-600" width="40" height="44"
                                 viewBox="0 0 40 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path
