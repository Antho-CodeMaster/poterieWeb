    ...
    @else
        <div class="relative flex items-center">
            ...
            <button id="prevBtn-{{ $collection->id_collection }}" class="prev-btn">
                <svg class="h-12 w-12 text-darkGrey absolute cursor-pointer z-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="none" viewBox="4 4 16 16">
            ...
            <button id="nextBtn-{{ $collection->id_collection }}" class="next-btn">
                <svg class="h-12 w-12 text-darkGrey absolute right-0 cursor-pointer z-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="none" viewBox="4 4 16 16">
