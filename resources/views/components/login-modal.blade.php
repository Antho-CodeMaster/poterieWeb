...
>
    ...
    <!-- Login Modal -->
    <div id="loginModal" x-show="openLogin" x-init="openLogin = document.getElementById('showLoginModal') ? true : false" class="fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center z-50">
