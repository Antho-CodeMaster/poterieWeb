<div x-cloak x-data="{ openLogin: {{ $errors->any() ? 'true' : 'false' }} }" @close-login-modal.window="openLogin = false"
    ...
    <!-- Login Modal -->
    <div id="loginModal" x-show="openLogin" x-init="openLogin = document.getElementById('showLoginModal') ? true : false"
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md relative">
            ...
            <div class="text-center my-8">
                <button @click.stop="openLogin = false; $dispatch('open-register-modal')"
