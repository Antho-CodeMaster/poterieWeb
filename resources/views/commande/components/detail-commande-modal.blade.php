<div
    x-cloak
    x-data="{ openCommande: {{ $errors->any() ? 'true' : 'false' }} }"
    @close-login-modal.window="openCommande = false"
>

    <!-- Trigger Button for Commande Modal -->
    ...
    <!-- Commande Modal -->
    <div x-show="openComande" class="fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center z-50">
