                ...
                {{-- ex layout une commande --}}
                    ...
                    <div class="flex my-24 ml-24">
                        ...
                        <div class="flex flex-col w-1/3 justify-between">
                            ...
                            <div class="flex">
                                <p>Statut : </p><p class="text-[{{$colors[$commande->transactions[0]->etat_transaction->etat]}}] underline"> {{$etat = $commande->transactions[0]->etat_transaction->etat === 'Annulé' ? ' Attention requise' : ' '.$etat}}</p>
                            </div>
